...
def matmul(a, b, matmul_fn):
    ...
    matmul_fn[grid](M,N,K, 1.0, 0.0, a, b, c)
    return c

naive_matmul  = partial(matmul, matmul_fn=naive_kernel)
global_matmul = partial(matmul, matmul_fn=global_mem_coalsce_kernel)
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        x_log=True,
        line_arg='provider',
        line_vals=['naive', 'global', 'torch'],
        line_names=['Naive', 'Global', 'Torch'],
